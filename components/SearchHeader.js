...
function SearchHeader() {
    ...
    return (
        ...
        <div className="flex w-full p-6 items-center">
            ...
            <form className="flex flex-grow  px-6 py-3 ml-10 mr-5 border border-gray-200 rounded-full 
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Google_mic.svg/1200px-Google_mic.svg.png"
                     className="h-5 mr-3 cursor-pointer hidden sm:inline-flex 
                                border-l-2 pl-4 border-gray-300"></img>                
            ...
            <Avatar className="ml-auto" url="https://media-exp1.licdn.com/dms/image/C4E03AQFbqbW-MOsjIA/profile-displayphoto-shrink_100_100/0/1596051692917?e=1627516800&v=beta&t=yzLzvgcSndpiqQab00tdDQHvQrCvcSGYYKtLetxahAQ"/>
        </div>
        {/* HeaderOptions */}
        <HeaderOptions />
        </header>
